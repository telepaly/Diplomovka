...
const MultiLevelAuthContract_artifacts = require('../../../../build/contracts/MultiLevelAuthContract.json');

@Injectable()
export class MultiLevelAuthContractService {
  ...
  private initializeContract() {
    ...
    this.web3Service.initializeContract(MultiLevelAuthContract_artifacts)
